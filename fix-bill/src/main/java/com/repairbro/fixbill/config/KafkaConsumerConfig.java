package com.repairbro.fixbill.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, DomainEvent> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "fix-bill-group");
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

        JsonDeserializer<DomainEvent> deserializer = new JsonDeserializer<>(DomainEvent.class);
        deserializer.addTrustedPackages("com.repairbro.commons.event");
